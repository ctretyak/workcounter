                ...
                $scope.$watch(function () {
                    ...
                    if (val) {
                        interval = $interval(function () {
                            $scope.left = moment(moment(8, 'HH').valueOf() - moment().valueOf() + moment(val, 'HH:mm').valueOf()).format('HH:mm:ss');
                        }, 100);
                    }
                });
            }])
                            ...
                            $timeout(function () {
                                ...
                                client.on("copy", function (event) {
                                    ...
                                    if (!getCookie('start_time_redmine')) {
                                        var start = moment($('input').val(), 'HH:mm:ss:SSS');
                                        setCookie('start_time_redmine', start.format('HH:mm'), {
                                            expires: start.endOf('day').toDate()
                                        });
                                    }
                                });
                            });
